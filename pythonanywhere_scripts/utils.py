...
def fetch_weeks_cloud(
    pull_latest_week_only: bool, datapath: str = "/home/jeroencvlier/option_chain_data/"
):
    ...
    list_of_options_per_week_on_cloud = sorted(list_of_options_per_week_on_cloud, reverse=True)

    if pull_latest_week_only:
        list_of_options_per_week_on_cloud = [list_of_options_per_week_on_cloud[0]]
                

        
    return list_of_options_per_week_on_cloud
